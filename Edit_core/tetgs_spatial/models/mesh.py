...
from tetgs_spatial.utils.ops import dot
from tetgs_spatial.utils.typing import *


class Mesh:
    def __init__(
        self, v_pos: Float[Tensor, "Nv 3"], t_pos_idx: Integer[Tensor, "Nf 3"], face_to_global_tet_idx: Optional[Float[Tensor, "Nf"]]=None, **kwargs
    ) -> None:
        ...
        self.face_to_global_tet_idx: Optional[Float[Tensor, "Nf"]] = face_to_global_tet_idx
    ...
    def remove_outlier(self, outlier_n_faces_threshold: Union[int, float]) -> Mesh:
        if self.requires_grad:
            tetgs_spatial.debug("Mesh is differentiable, not removing outliers")
            return self
    ...
    def _unwrap_uv(
        ...
        tetgs_spatial.info("Using xatlas to perform UV unwrapping, may take a while ...")
