...
from tetgs_spatial.utils.config import config_to_primitive
from tetgs_spatial.utils.misc import get_rank
from tetgs_spatial.utils.ops import get_activation
...
class ProgressiveBandHashGrid(nn.Module, Updateable):
    ...
    def update_step(self, epoch, global_step, on_load_weights=False):
        ...
        if current_level > self.current_level:
            tetgs_spatial.debug(f"Update current level to {current_level}")
