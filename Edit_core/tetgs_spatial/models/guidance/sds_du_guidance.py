...
from tetgs_spatial.models.prompt_processors.base import PromptProcessorOutput
from tetgs_spatial.utils.base import BaseObject
from tetgs_spatial.utils.misc import parse_version, C
from tetgs_spatial.utils.typing import *
from tetgs_spatial.utils.perceptual import PerceptualLoss


@tetgs_spatial.register("sds-du-guidance")
class SDSDUGuidance(BaseObject):
    ...
    def configure(self) -> None:
        tetgs_spatial.info(f"Loading Stable Diffusion ...")
        ...
        tetgs_spatial.info(f"Loaded Stable Diffusion!")
    ...
    def edit_latents(
        ...
        with torch.no_grad():
            ...
            tetgs_spatial.debug("Start editing...")
            ...
            tetgs_spatial.debug("Editing finished.")
        return latents
